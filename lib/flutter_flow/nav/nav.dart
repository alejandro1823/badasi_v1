...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'boarding',
          path: '/boarding',
          builder: (context, params) => const BoardingWidget(),
        ),
        FFRoute(
          name: 'VerPost',
          path: '/verPost',
          asyncParams: {
            'postId': getDoc(['users', 'posts'], PostsRecord.fromSnapshot),
          },
          builder: (context, params) => VerPostWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CrearPost')
